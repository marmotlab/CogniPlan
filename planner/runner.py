...
class Runner(object):
    ...
    def do_job(self, episode_number):
        ...
        # save_img = True
        worker = Worker(self.meta_agent_id, self.local_network, self.local_q_net, self.predictor, episode_number, device=self.device, save_image=save_img, greedy=False)
