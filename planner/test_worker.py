...
class TestWorker:
    def __init__(self, meta_agent_id, policy_net, predictor, global_step, device='cuda', greedy=False, save_image=False):
        self.device = device
        self.greedy = greedy
        ...
        self.env = Env(map_index=self.global_step, predictor=predictor, k_size=self.k_size, plot=save_image, test=True)
