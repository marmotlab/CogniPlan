FOLDER_NAME = 'cogniplan_nav_pred4_test'
...
BATCH_SIZE = 64 
INPUT_DIM = 9   # the dimension of policy network input
EMBEDDING_DIM = 128 # the dimension of embedding vector
NODE_PADDING_SIZE = 650  # the number of nodes will be padded to this value
